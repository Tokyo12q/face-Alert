...
# ---------------------------------------------------------------------------
# MediaPipe 0.10.x Tasks API for Face Landmarker (Replacement for Face Mesh)
# ---------------------------------------------------------------------------
...
class ProctorDetector:
    ...
    def detect_faces(self, bgr_frame):
        # MediaPipe tasks expect mp.Image
    ...
    def get_eye_rois(self, bgr_frame, primary_face):
        ...
        # Indices for eyes in Face Landmarker (same as Mesh)
    ...
    def __del__(self):
        # Landmarker might not be initialized if model download fails
